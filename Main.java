...
import com.cap.service.BankServiceDao;
import com.cap.service.BankServiceDaoImp;
...
public class Main {
	...
	public static void display(List<Bank> banklist)
	{
		for(Bank b:banklist)
		{
			...
			System.out.println(b.getMobile_no());
			System.out.println(b.getPasswd());
		}
	}

	public static void main(String[] args) throws BankException{
		BankServiceDao service=new BankServiceDaoImp();
		Bank bk=new Bank();
		do {
			System.out.println("-----------------------------------------");
			...
			case 4:
				...
				break;
			case 5:
				List<Bank> list=service.getCustomer();
				display(list);
				break;
			case 6:
				try {
					...
					if(service.transFund(a, bk, bk1))
					{
						...
						System.out.println("Balance="+service.showbal(bk1));
					}
					else {
