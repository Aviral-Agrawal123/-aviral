...
public class BankModules {
	...
	public void fundTransfer() {
		...
		{
			System.out.println("You cannot transfer money in same account..");
			System.out.println("Plz. Enter another account number");
		}
		else
		{
